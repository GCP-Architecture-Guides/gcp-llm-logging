...
def log_object(object_url, checksum):
    ...
    logging_bucket = "gen-ai-logging-bucket" 
...
def deidentify_with_deterministic(
    ...
    # Convert the project id into a full resource id.
    parent = f"projects/{project}/locations/global"
    bucket_name = "gen-ai-logging-bucket"
    ...
    key_name = "projects/lanreo-project/locations/global/keyRings/demo-key-ring/cryptoKeys/gen-ai-demo"
...
def prompt_fn(contents, dlp_mode):
    ...
    if contents !="":
        ...
        if dlp_mode == "img_redact":          # Call DLP redact image
            ...
            # input_file = contents[1].file_data.file_uri.split("/")[-2] +"/"+ contents[1].file_data.file_uri.split("/")[-1]
            ...
            inspect_template = "projects/lanreo-project/locations/global/inspectTemplates/redaction_template"
...
if __name__ == '__main__':
    ...
    # Add arguments
    parser.add_argument(
        "--dlp_mode", required=False, help="valid values encrypt, mask or img_redact"
    )
    # Parse the arguments
    ...
    #testing for image redaction
    image_file_uri = "gs://gen-ai-logging-bucket/sensitive-data-images.png"
